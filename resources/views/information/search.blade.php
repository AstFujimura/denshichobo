...
<form class="searchform" action="{{route('searchPost')}}" method="get" enctype="multipart/form-data">
    <div class="searchbox">
        <div class="searchelement">
            ...
            <input type="text" id="startyear" name="starthiduke" value="{{$starthiduke}}"  class="searchinputtext">
            ~
            <input type="text" id="endyear" name="endhiduke" value="{{$endhiduke}}" class="searchinputtext">
        </div>
        <div class="searchelement">
