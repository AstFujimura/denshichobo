...
<div class="loader">
    <img src="{{ asset(config('prefix.prefix').'asset/'.'img/loading.gif')}}">
...
<div class="top_table_element">
    ...
    <div class="top_table_body">
        ...
        <div class="delete_table">
            ...
            <img src="{{ asset(config('prefix.prefix').'asset/'.'img/download_2_line.svg')}}" id='/{{$prefix}}/download/{{$file->id}}' class="download downloadbutton">
            </div>
            ...
            <div class="preview">
                ...
                <img src="{{ asset(config('prefix.prefix').'asset/'.'img/file_search_line.svg')}}" class="download previewbutton" id="{{$file->id}}">
                @endif
            </div>
            <div class="hennkou">
                @if ($file->削除フラグ != "済")
                <img src="{{ asset(config('prefix.prefix').'asset/'.'img/transfer_3_fill.svg')}}" class="download" onclick="location.href='/{{$prefix}}/edit/{{$file->過去データID}}';">
