    ...
    <div class="flow_master_table">
        ...
        <div class="flow_master_tbody">
            ...
            <div class="flow_master_tr">
                ...
                <div class="flow_master_edit"><div onclick="location.href='{{$prefix}}/workflowedit/{{$flow->id}}';" class="flow_master_edit_button">編集</div></div>
                <div class="flow_master_delete"><div class="flow_master_delete_button">削除</div></div>
            </div>
            @endforeach
        </div>
