...
<div class="menu001">
    ...
    <div class="headerIcon001" id="registpagebutton">
        <img src="{{ asset(config('prefix.prefix').'asset/'.'img/pencil_2_line_gray.svg') }}" class="menuicon01">
        ...
        <div class="sidebar01">
            ...
            <div class="sidebarcontent01">
                ...
                <a href="{{route('registGet')}}" class="button1_01">
                    <div class="button1element01">
                        <div class="button1logo01">
                            <img src="{{ asset(config('prefix.prefix').'asset/'.'img/pencil_2_line.svg') }}">
                        </div>
                        <div class="button1name01">
                            帳簿保存
                        </div>
...
<script src="{{ asset(config('prefix.prefix').'asset/'.'js/usersetting.js') }}"></script>
