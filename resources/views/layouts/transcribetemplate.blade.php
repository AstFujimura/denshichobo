...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset(config('prefix.prefix').'/'.'css/transcribestyle.css') }}">
...
<body>
    <div class="page-container01">
        <div class="sidebar01">
            ...
            <a href="{{route('transcribeget')}}" class="button1_01">
...
<script src="{{ asset(config('prefix.prefix').'/'.'js/transcribe.js') }}"></script>
